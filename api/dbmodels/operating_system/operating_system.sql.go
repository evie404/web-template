...
func (q *Queries) CreateOne(ctx context.Context, arg CreateOneParams) (OperatingSystem, error) {
...
func (q *Queries) ListByPattern(ctx context.Context, arg ListByPatternParams) ([]OperatingSystem, error) {
...
func (q *Queries) ListOffset(ctx context.Context, arg ListOffsetParams) ([]OperatingSystem, error) {
