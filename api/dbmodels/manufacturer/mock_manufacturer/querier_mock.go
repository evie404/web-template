...
// Source: dbmodels/manufacturer/querier.go

// Package mock_manufacturer is a generated GoMock package.
package mock_manufacturer

import (
	context "context"
	gomock "github.com/golang/mock/gomock"
	manufacturer "github.com/rickypai/web-template/api/dbmodels/manufacturer"
	reflect "reflect"
)
...
func (m *MockQuerier) CreateOne(ctx context.Context, arg manufacturer.CreateOneParams) (manufacturer.Manufacturer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateOne", ctx, arg)
	ret0, _ := ret[0].(manufacturer.Manufacturer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockQuerier) GetByID(ctx context.Context, id int64) (manufacturer.Manufacturer, error) {
	m.ctrl.T.Helper()
...
func (m *MockQuerier) GetManyByIDs(ctx context.Context, dollar_1 []int64) ([]manufacturer.Manufacturer, error) {
	m.ctrl.T.Helper()
...
func (m *MockQuerier) ListByPattern(ctx context.Context, arg manufacturer.ListByPatternParams) ([]manufacturer.Manufacturer, error) {
	m.ctrl.T.Helper()
...
func (m *MockQuerier) ListOffset(ctx context.Context, arg manufacturer.ListOffsetParams) ([]manufacturer.Manufacturer, error) {
	m.ctrl.T.Helper()
