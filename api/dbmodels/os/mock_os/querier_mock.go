...
func (m *MockQuerier) CreateOne(ctx context.Context, arg os.CreateOneParams) (os.OS, error) {
	m.ctrl.T.Helper()
...
func (m *MockQuerier) ListByPattern(ctx context.Context, arg os.ListByPatternParams) ([]os.OS, error) {
	m.ctrl.T.Helper()
