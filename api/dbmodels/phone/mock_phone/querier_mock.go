...
func (m *MockQuerier) GetManyByIDs(ctx context.Context, dollar_1 []int64) ([]phone.Phone, error) {
	m.ctrl.T.Helper()
...
func (m *MockQuerier) ListByPattern(ctx context.Context, arg phone.ListByPatternParams) ([]phone.Phone, error) {
	m.ctrl.T.Helper()
