...
type GetPageByCursorRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	Count  int64 `protobuf:"varint,3,opt,name=count,proto3" json:"count,omitempty"` // defaults to 20
}

func (x *GetPageByCursorRequest) Reset() {
	*x = GetPageByCursorRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetPageByCursorRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetPageByCursorRequest) ProtoMessage() {}

func (x *GetPageByCursorRequest) ProtoReflect() protoreflect.Message {
	mi := &file_protobuf_phone_phone_service_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetPageByCursorRequest.ProtoReflect.Descriptor instead.
func (*GetPageByCursorRequest) Descriptor() ([]byte, []int) {
	return file_protobuf_phone_phone_service_proto_rawDescGZIP(), []int{2}
}

func (x *GetPageByCursorRequest) GetCursor() int64 {
	if x != nil {
		return x.Cursor
	}
	return 0
...
func (x *GetPageByCursorRequest) GetLimit() int64 {
	if x != nil {
		return x.Limit
	}
	return 0
...
func (x *GetPageByCursorRequest) GetCount() int64 {
	if x != nil {
		return x.Count
	}
	return 0
...
type GetPageByCursorResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetPageByCursorResponse) Reset() {
	*x = GetPageByCursorResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetPageByCursorResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetPageByCursorResponse) ProtoMessage() {}

func (x *GetPageByCursorResponse) ProtoReflect() protoreflect.Message {
	mi := &file_protobuf_phone_phone_service_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetPageByCursorResponse.ProtoReflect.Descriptor instead.
func (*GetPageByCursorResponse) Descriptor() ([]byte, []int) {
	return file_protobuf_phone_phone_service_proto_rawDescGZIP(), []int{3}
}

func (x *GetPageByCursorResponse) GetResults() []*Phone {
	if x != nil {
		return x.Results
	}
	return nil
...
func (x *GetPageByCursorResponse) GetCursor() int64 {
	if x != nil {
		return x.Cursor
	}
	return 0
...
var file_protobuf_phone_phone_service_proto_rawDesc = []byte{
	...
	0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x5c, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x50,
	0x61, 0x67, 0x65, 0x42, 0x79, 0x43, 0x75, 0x72, 0x73, 0x6f, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	,
...
var file_protobuf_phone_phone_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_protobuf_phone_phone_service_proto_goTypes = []interface{}{
	...
	(*GetPageByCursorRequest)(nil),  // 2: phone.GetPageByCursorRequest
	(*GetPageByCursorResponse)(nil), // 3: phone.GetPageByCursorResponse
	(*Phone)(nil),                   // 4: phone.Phone
}
var file_protobuf_phone_phone_service_proto_depIdxs = []int32{
	4, // 0: phone.GetOneByIDResponse.result:type_name -> phone.Phone
	4, // 1: phone.GetPageByCursorResponse.results:type_name -> phone.Phone
	0, // 2: phone.PhoneService.GetOneByID:input_type -> phone.GetOneByIDRequest
	2, // 3: phone.PhoneService.GetPageByCursor:input_type -> phone.GetPageByCursorRequest
	1, // 4: phone.PhoneService.GetOneByID:output_type -> phone.GetOneByIDResponse
	3, // 5: phone.PhoneService.GetPageByCursor:output_type -> phone.GetPageByCursorResponse
...
func file_protobuf_phone_phone_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_protobuf_phone_phone_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetPageByCursorRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_protobuf_phone_phone_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetPageByCursorResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
