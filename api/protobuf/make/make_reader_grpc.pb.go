...
func (c *makeReaderClient) ListByPrefix(ctx context.Context, in *ListByPrefixRequest, opts ...grpc.CallOption) (*ListByPrefixResponse, error) {
	out := new(ListByPrefixResponse)
	err := c.cc.Invoke(ctx, "/make.MakeReader/ListByPrefix", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMakeReaderServer) ListByPrefix(context.Context, *ListByPrefixRequest) (*ListByPrefixResponse, error) {
...
func _MakeReader_ListByPrefix_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListByPrefixRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MakeReaderServer).ListByPrefix(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/make.MakeReader/ListByPrefix",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MakeReaderServer).ListByPrefix(ctx, req.(*ListByPrefixRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MakeReader_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _MakeReader_ListByPrefix_Handler,
		},
	},
