...
func CreatedAt(v time.Time) predicate.Manufacturer {
	return predicate.Manufacturer(func(s *sql.Selector) {
...
func ModifiedAt(v time.Time) predicate.Manufacturer {
	return predicate.Manufacturer(func(s *sql.Selector) {
...
func CreatedAtEQ(v time.Time) predicate.Manufacturer {
	return predicate.Manufacturer(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldCreatedAt), v))
	})
}
...
func CreatedAtNEQ(v time.Time) predicate.Manufacturer {
	return predicate.Manufacturer(func(s *sql.Selector) {
...
func CreatedAtIn(vs ...time.Time) predicate.Manufacturer {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func CreatedAtNotIn(vs ...time.Time) predicate.Manufacturer {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func CreatedAtGT(v time.Time) predicate.Manufacturer {
	return predicate.Manufacturer(func(s *sql.Selector) {
...
func CreatedAtGTE(v time.Time) predicate.Manufacturer {
	return predicate.Manufacturer(func(s *sql.Selector) {
...
func CreatedAtLT(v time.Time) predicate.Manufacturer {
	return predicate.Manufacturer(func(s *sql.Selector) {
...
func CreatedAtLTE(v time.Time) predicate.Manufacturer {
	return predicate.Manufacturer(func(s *sql.Selector) {
...
func ModifiedAtEQ(v time.Time) predicate.Manufacturer {
	return predicate.Manufacturer(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldModifiedAt), v))
	})
}
...
func ModifiedAtNEQ(v time.Time) predicate.Manufacturer {
	return predicate.Manufacturer(func(s *sql.Selector) {
...
func ModifiedAtIn(vs ...time.Time) predicate.Manufacturer {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ModifiedAtNotIn(vs ...time.Time) predicate.Manufacturer {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ModifiedAtGT(v time.Time) predicate.Manufacturer {
	return predicate.Manufacturer(func(s *sql.Selector) {
...
func ModifiedAtGTE(v time.Time) predicate.Manufacturer {
	return predicate.Manufacturer(func(s *sql.Selector) {
...
func ModifiedAtLT(v time.Time) predicate.Manufacturer {
	return predicate.Manufacturer(func(s *sql.Selector) {
...
func ModifiedAtLTE(v time.Time) predicate.Manufacturer {
	return predicate.Manufacturer(func(s *sql.Selector) {
...
func HasPhones() predicate.Manufacturer {
	return predicate.Manufacturer(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(PhonesTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2O, false, PhonesTable, PhonesColumn),
		)
...
func HasPhonesWith(preds ...predicate.Manufacturer) predicate.Manufacturer {
	return predicate.Manufacturer(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
