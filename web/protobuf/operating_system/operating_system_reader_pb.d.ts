...
export class GetOneByIDResponse extends jspb.Message {
  ...
  setResult(value?: protobuf_operating_system_operating_system_pb.OperatingSystem): GetOneByIDResponse;
  hasResult(): boolean;
...
export class GetManyByIDsResponse extends jspb.Message {
  getResultsList(): Array<protobuf_operating_system_operating_system_pb.OperatingSystem>;
  setResultsList(value: Array<protobuf_operating_system_operating_system_pb.OperatingSystem>): GetManyByIDsResponse;
  clearResultsList(): GetManyByIDsResponse;
  addResults(value?: protobuf_operating_system_operating_system_pb.OperatingSystem, index?: number): protobuf_operating_system_operating_system_pb.OperatingSystem;
...
export namespace GetManyByIDsResponse {
  export type AsObject = {
    resultsList: Array<protobuf_operating_system_operating_system_pb.OperatingSystem.AsObject>,
  }
}
...
export class ListByCursorResponse extends jspb.Message {
  getResultsList(): Array<protobuf_operating_system_operating_system_pb.OperatingSystem>;
  setResultsList(value: Array<protobuf_operating_system_operating_system_pb.OperatingSystem>): ListByCursorResponse;
...
export class ListByPageResponse extends jspb.Message {
  getResultsList(): Array<protobuf_operating_system_operating_system_pb.OperatingSystem>;
  setResultsList(value: Array<protobuf_operating_system_operating_system_pb.OperatingSystem>): ListByPageResponse;
...
export class ListByPrefixResponse extends jspb.Message {
  getResultsList(): Array<protobuf_operating_system_operating_system_pb.OperatingSystem>;
  setResultsList(value: Array<protobuf_operating_system_operating_system_pb.OperatingSystem>): ListByPrefixResponse;
