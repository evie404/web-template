...
export class CreateOneRequest extends jspb.Message {
  getRequest(): protobuf_make_make_pb.Make | undefined;
  setRequest(value?: protobuf_make_make_pb.Make): CreateOneRequest;
  hasRequest(): boolean;
...
export namespace CreateOneRequest {
  export type AsObject = {
    request?: protobuf_make_make_pb.Make.AsObject,
  }
}
