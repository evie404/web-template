...
export class PhoneReaderClient {
  ...
  methodInfoListByPrefix = new grpcWeb.AbstractClientBase.MethodInfo(
    protobuf_phone_phone_reader_pb.ListByPrefixResponse,
    (request: protobuf_phone_phone_reader_pb.ListByPrefixRequest) => {
      return request.serializeBinary();
    },
    protobuf_phone_phone_reader_pb.ListByPrefixResponse.deserializeBinary
  );

  listByPrefix(
    request: protobuf_phone_phone_reader_pb.ListByPrefixRequest,
    metadata: grpcWeb.Metadata | null): Promise<protobuf_phone_phone_reader_pb.ListByPrefixResponse>;

  listByPrefix(
    request: protobuf_phone_phone_reader_pb.ListByPrefixRequest,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.Error,
               response: protobuf_phone_phone_reader_pb.ListByPrefixResponse) => void): grpcWeb.ClientReadableStream<protobuf_phone_phone_reader_pb.ListByPrefixResponse>;

  listByPrefix(
    request: protobuf_phone_phone_reader_pb.ListByPrefixRequest,
    metadata: grpcWeb.Metadata | null,
    callback?: (err: grpcWeb.Error,
               response: protobuf_phone_phone_reader_pb.ListByPrefixResponse) => void) {
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ +
          '/phone.PhoneReader/ListByPrefix',
        request,
        metadata || {},
