...
export class CreateOneRequest extends jspb.Message {
  getRequest(): protobuf_phone_phone_pb.PhoneCreateRequest | undefined;
  setRequest(value?: protobuf_phone_phone_pb.PhoneCreateRequest): CreateOneRequest;
  hasRequest(): boolean;
...
export namespace CreateOneRequest {
  export type AsObject = {
    request?: protobuf_phone_phone_pb.PhoneCreateRequest.AsObject,
  }
}
